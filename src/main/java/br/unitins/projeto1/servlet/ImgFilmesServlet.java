package br.unitins.projeto1.servlet;
...
@WebServlet("/img-filmes")
public class ImgFilmesServlet extends HttpServlet{
	...
	// /images/usuario
	public static final String PATH_IMAGES_FILMES = PATH_IMAGES + File.separator;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String diretorio = System.getProperty("user.home") + File.separator + PATH_IMAGES + File.separator;
